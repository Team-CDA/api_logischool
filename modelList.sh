    ...
    npx sequelize-cli model:create --name classes --attributes name:string,scolarity_year:string,id_class_type:integer
    ...
    npx sequelize-cli model:create --name homeworks_classes --attributes id_class:integer,id_homework:integer,plannified_date:date,correction_date:date
