 ...
 *         
 */
router.get('/:id/:file', multerMultipleFiles, homeworksController.getOneFileById)
 ...
 *            description: homeworks_classes successfully retrieved
 */
router.get('/classes/:id', multerMultipleFiles, homeworksController.getOneByIdHC)
 ...
 */
router.post('/classes/create', multerMultipleFiles, homeworksController.createHC)
 ...
 */
router.put('/classes/update/:id', multerMultipleFiles, homeworksController.updateHC)
 ...
 */
router.delete('/classes/:id', multerMultipleFiles, homeworksController.deleteOneByIdHC)
